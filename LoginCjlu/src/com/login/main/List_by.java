...
public class List_by extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter listAdapter = new SimpleAdapter(this, list,
				R.layout.list_by_1, new String[] { "by_title", "by_name" },
				new int[] { R.id.by_title, R.id.by_name });
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		HashMap<String, String> item = (HashMap<String, String>) l
		...
		dialog.setTitle("详细").setIcon(android.R.drawable.ic_dialog_info)
				.setMessage(title + "\n" + name)
