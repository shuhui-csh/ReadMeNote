...
public class List_ks extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
	        ...
	        SimpleAdapter listAdapter = new SimpleAdapter(this, list, R.layout.list_ks_1, new String[]{"ks_date", "ks_name","ks_address","ks_address2"}, new int[]{R.id.ks_date, R.id.ks_name,R.id.ks_address,R.id.ks_address2});
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (position != 0) {
			for (int i = 0; i < 8; i++) {
				temp[i] = ss[i]+": "+ss[(position )* 8 + i].replaceAll("&nbsp;", "");
			}
